      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 pt-20 md:hidden flex flex-col"
            style={{ background: "var(--color-bg-glass)", backdropFilter: "blur(20px)" }}
          >
            <nav className="flex flex-col items-center gap-3 p-6 flex-1 justify-center">
              {navLinks.map((link, i) => (
                <motion.a
                  key={link.href}
                  href={link.href}
            ...
            <div className="flex flex-col items-center gap-2 pb-8 pt-4" style={{ borderTop: "1px solid var(--color-border)" }}>
